...
public class BeanDefinitionParserDelegate {
	...
	public BeanDefinitionHolder parseBeanDefinitionElement(Element ele, @Nullable BeanDefinition containingBean) {
		...
		//校验bean名称的重复性 不论是 id 还是alias都不可以重复
	...
	public void parseConstructorArgElement(Element ele, BeanDefinition bd) {
		// <constructor-arg index="0" value="yangqiang"/>
		String indexAttr = ele.getAttribute(INDEX_ATTRIBUTE);
		// <constructor-arg type="String" value="yangqiang"/>
		String typeAttr = ele.getAttribute(TYPE_ATTRIBUTE);
		// <constructor-arg name="name" value="yangqiang"/>
		String nameAttr = ele.getAttribute(NAME_ATTRIBUTE);
	...
	public BeanDefinition parseCustomElement(Element ele, @Nullable BeanDefinition containingBd) {
		//得到自定义或者 外部扩展的namespaceUri http://time.geekbang.org/schema/users
		String namespaceUri = getNamespaceURI(ele);
		if (namespaceUri == null) {
			return null;
		}
		//得到对应的NamespaceHandler
